...
if 'ZunzunOriginalDoc' not in sc.sticky:
    sc.sticky['ZunzunOriginalDoc'] = canvas.Document
    sc.sticky['ZunzunOriginalViewport'] = canvas.Viewport.Duplicate()
    ...
    if original is not None:
        ...
        sc.sticky['ZunzunOriginalDoc'] = original
        sc.sticky['ZunzunOriginalViewport'] = canvas.Viewport.Duplicate()
...
assembly = System.Reflection.Assembly.LoadFrom(os.path.join(root, 'test-output', 'WireShelf.ZunzunTest01.dll'))
runtime = assembly.GetType('WireShelf.ShelfRuntime')
...
styles=assembly.GetType('WireShelf.WireStyles')
...
canvas.Invalidate()
print('Zunzun preview ready. Original definition retained.')
