...
a=System.Reflection.Assembly.LoadFrom(os.path.join(root,'test-output','Polymita.Polymita051Test01.dll'))
try:
 ...
 canvas.Invalidate()
print('Polymita 0.5.1 navigation and labels test build active.')
