...
public static class GestureTests
{
    ...
    public static void Run(string root)
    {
        ...
        try {
            ...
            delta=AlignmentGeometry.Snap(new RectangleF(100,100,40,40),none,new[]{new PointF(500,140)},8,120,out x,out y,out kx,out ky);
            Check(delta.Y==20 && ky==AlignmentGeometry.Port,"A wired port pulls the anchor from four times the plain tolerance");
            delta=AlignmentGeometry.Snap(new RectangleF(100,100,40,40),none,new[]{new PointF(500,160)},8,120,out x,out y,out kx,out ky);
